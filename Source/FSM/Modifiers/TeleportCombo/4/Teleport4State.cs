...
{
    public override string BindState => "Teleport 4";
        ...
        FsmState bindState = new FsmState(fsm.Fsm)
        {
            ...
            [
                ...
                new TeleportAction()
                {
                    ...
                    MaxX = 163f,
                    MaxAttempts = 5,
                    MinTeleportDistance = -6f,
                    MaxTeleportDistance = -6.5f
                },
                new Wait()
                {
                    time = 0.01f,
            ...
            Transitions = [
                new FsmTransition()
                {
                    ...
                    ToState = "Teleport 4 Recovery",
                    ToFsmState = fsm.Fsm.GetState("Teleport 4 Recovery")
                },
            ]
        };
